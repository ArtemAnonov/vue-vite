  ...
  >
    <div class="catalog-revealing__actions">
      ...
      >
        ...
        <span class="catalog-revealing__arrow icon-arrow"></span>
      </ButtonNode>
    </div>
    <div class="catalog-revealing__body" v-show="element.active">
      <div class="catalog-revealing__main">
        <slot name="main"></slot>
      </div>
      <div class="catalog-revealing__nested-actions">
        <ButtonNode class="catalog-revealing__button" @click="setDefault"
          >Очистить</ButtonNode
        >
