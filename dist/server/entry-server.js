...
import { useSSRContext, mergeProps, resolveComponent, withCtx, openBlock, createBlock, createCommentVNode, createVNode, Fragment, renderList, toDisplayString, withDirectives, vShow, renderSlot, createTextVNode, ref, vModelText, withModifiers, resolveDynamicComponent, Suspense, createSSRApp } from "vue";
  ...
  data() {
    ...
    return {
      ...
      message: {
        ...
        classes: {
          "icon-check": ((_a = this.message) == null ? void 0 : _a.current.type) === "success",
          "error": ((_b = this.message) == null ? void 0 : _b.current.type) === "error"
        }
      }
    };
  },
              ...
              if (((_a = _ctx.cartItems) == null ? void 0 : _a.length) || Object.keys(_ctx.cartStore).length === 0) {
                _push3(ssrRenderComponent(_component_middle_content_node, null, {
                  ...
                  sidebar: withCtx((_3, _push4, _parent4, _scopeId3) => {
                    ...
                    if (_push4) {
                      _push4(`<div class="middle-content__sidebar"${_scopeId3}><div class="middle-content__block middle-content__block_promo"${_scopeId3}><div class="middle-content__key middle-content__key_medium"${_scopeId3}>\u041F\u0440\u043E\u043C\u043E\u043A\u043E\u0434</div><div class="middle-content__item"${_scopeId3}>`);
                      _push4(ssrRenderComponent(_component_input_node, {
                        placeholder: "\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043F\u0440\u043E\u043C\u043E\u043A\u043E\u0434",
                        class: "main",
                        modelValue: _ctx.promo,
                        "onUpdate:modelValue": ($event) => _ctx.promo = $event
                      }, null, _parent4, _scopeId3));
  ...
  _push(ssrRenderComponent(_component_container_node, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(`</div><div class="header_light__call"${_scopeId}><button class="icon-call"${_scopeId}></button><div class="header_light__text"${_scopeId}>\u0411\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u043E \u043F\u043E \u0420\u043E\u0441\u0441\u0438\u0438</div><div class="header_light__tel"${_scopeId}>8 800 999 09 99</div></div></div>`);
      } else {
        return [
          createVNode("div", { class: "header_light__body" }, [
            ...
            createVNode("div", { class: "header_light__call" }, [
              createVNode("button", { class: "icon-call" }),
